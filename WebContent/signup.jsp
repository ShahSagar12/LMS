				...
				<div class="login-form bg-light mt-4 p-4">
					<form class="row g-3">
						...
						<div class="col-auto">
							...
							<select class="form-select" id="register-as" name="role">
						...
						<div class="col-12">
							<button type="button" class="btn btn-dark float-end" id="btn-signup">Signup</button>
						</div>
					</form>
					<hr class="mt-4">
					<div class="col-12">
